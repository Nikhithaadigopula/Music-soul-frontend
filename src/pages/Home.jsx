  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center space-y-3 bg-[rgba(0,0,0,0.2)]  w-full h-screen -mt-40 lg:-mt-20">
        <h1 className="text-3xl lg:text-5xl text-white font-bold hero-enter-active">Soul Music</h1>
        ...
        <div className="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-5">
          ...
          <Link to={'/explore'} className="bg-lime-300 w-32 py-1 rounded-md flex justify-center text-[#461e74]">Explore</Link>
        </div>
      </div>
    </div>
  );
